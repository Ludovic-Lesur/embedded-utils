...
/*!******************************************************************
 * \fn AT_status_t AT_init(uint8_t instance, AT_process_callback_t process_callback)
 * \brief Initialize AT command manager.
 * \param[in]   instance: AT instance to initialize.
...
/*!******************************************************************
 * \fn AT_status_t AT_de_init(uint8_t instance)
 * \brief Release AT command manager.
 * \param[in]   instance: AT instance to release.
 * \param[out]  none
 * \retval      Function execution status.
 *******************************************************************/
 ...
 * \param[in]   instance: AT instance to process.
 * \param[out]  none
 * \retval      Function execution status.
 *******************************************************************/
...
/*!******************************************************************
 * \fn AT_status_t AT_register_command(uint8_t instance, const AT_command_t* command)
 * \brief Register an AT command.
 * \param[in]   instance: AT instance to use.
...
/*!******************************************************************
 * \fn AT_status_t AT_unregister_command(uint8_t instance, const AT_command_t* command)
...
/*!******************************************************************
 * \fn void AT_reply_add_string(uint8_t instance, char_t* str)
...
/*!******************************************************************
 * \fn void AT_reply_add_integer(uint8_t instance, int32_t value, STRING_format_t format, uint8_t print_prefix)
...
/*!******************************************************************
 * \fn void AT_send_reply(uint8_t instance)
